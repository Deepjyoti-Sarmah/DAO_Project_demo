...
const connectWallet = async() => {
    try{
        if(!ethereum) return alert("Please install Metamass Extension in your browser");
...
const isWalletConnected = async() => {
    try{
        if(!ethereum) return alert("Please install Metamass");
...
const getProposal = async(id) => {
    try {
        const proposals =getGlobalState()
